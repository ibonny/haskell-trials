...
/* package sample-scotty-project-0.1.0.0 */
#ifndef VERSION_sample_scotty_project
#define VERSION_sample_scotty_project "0.1.0.0"
#endif /* VERSION_sample_scotty_project */
#ifndef MIN_VERSION_sample_scotty_project
#define MIN_VERSION_sample_scotty_project(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sample_scotty_project */
...
#define CURRENT_COMPONENT_ID "sample-scotty-project-0.1.0.0-inplace-sample-scotty-project"
